...
export const SEQUENCE_WINDOWS: SequenceWindow[] = [
  { index: 1, phase: '1OS', label: '1st OS', caption: 'NBA Lockers / Kitchen / Sideline Club' },
  { index: 2, phase: '1DS', label: '1st DS', caption: 'Concessions / Restrooms · North Club & South Infill' },
  { index: 3, phase: '2OS', label: '2nd OS', caption: 'WNBA Lockers / Courtside & Sideline Club' },
  { index: 4, phase: '2DS', label: '2nd DS', caption: 'Secondary Entrance / Restrooms / Concessions · Rotunda & South Club' },
  { index: 5, phase: '3OS', label: '3rd OS', caption: 'Concourse / Primary Entrance · Center Court Club / Suites · Complete Renovations' },
  { index: 6, phase: '3DS', label: '3rd DS', caption: 'Press & Alaska Club Renovations · Concourse & Balance' },
]
